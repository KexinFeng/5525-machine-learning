...
class LRmd():
    ...
    def IRLS_basic(self, x_train, t_train, yita = 1, max_count = 500, rel_err = 1e-5):
        ...
        while 1:
            ...
            if abs(E_temp - E)/E < rel_err and count > 5e2:
...
def main():
    b_or_d = 'd'
    x_train, x_test, t_train, t_test = LRmd().extract_data(b_or_d)
    # b: yita == 1e3
    ...
    w = LRmd().IRLS_basic(x_train, t_train, yita = yita, max_count = max_count, rel_err=1e-2)
    # print('yita = ', yita)
